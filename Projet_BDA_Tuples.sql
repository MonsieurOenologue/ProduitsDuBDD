...
(
    ...
    Client_t('Jean', 0666953278, '5 rue Albert Premier'),
...
(
    ...
    Client_t('Chloé', 0656333609, '22 rue de la Vaslière'),
...
(
    ...
    Client_t('Robert', 0668321234, '3 Avenue de Rome'),
...
(
    ...
    Client_t('Ernesto', 0626884251, '18 Avenue d Occitanie'),
